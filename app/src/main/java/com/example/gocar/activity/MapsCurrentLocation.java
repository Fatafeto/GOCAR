 ...
 */
public class MapsCurrentLocation extends AppCompatActivity implements OnMapReadyCallback {

    private static final String TAG = MapsCurrentLocation.class.getSimpleName();
