...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Creating Tables
    @Override
    public void onCreate(SQLiteDatabase db) {       //NOT SURE
     ...
     * */
    public void addUser(String name, String email, String uid, String created_at, String age, String nationality, String phone_no) {     //NOT SURE
    ...
    public HashMap<String, String> getUserDetails() {
        HashMap<String, String> user = new HashMap<String, String>();   //NOT SURE
        ...
        // Move to first row
        cursor.moveToFirst();
        if (cursor.getCount() > 0) {        //HERE LESSA
